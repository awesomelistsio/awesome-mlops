...
- [traceAI](https://github.com/future-agi/traceAI) – Open-source OpenTelemetry-native tracing framework that auto-instruments 20+ AI frameworks and LLM providers, capturing prompts, tokens, latency, and errors.
